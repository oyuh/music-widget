...
You don't need a Jamlog account, and the widget has no watermark. Your design lives in the widget URL instead of a server-side project.

The wiki and playground work on phones. Use a desktop for the full editor. The widget itself renders anywhere.
