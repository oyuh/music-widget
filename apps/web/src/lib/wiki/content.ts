...
export const pages = [
  ...
  { slug: "animations", file: "Animations", title: "Animate your widget", label: "Animations", group: "Build your widget", description: "Add playback, song-change, per-letter, image, and custom motion to any element." },
